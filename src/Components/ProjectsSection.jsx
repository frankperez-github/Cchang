...
function Projects(){
    return(
        <div className="Projects mobContainer">
            <h2>Proyectos</h2>
            <ProjectCard text="Remodelación de las oficinas comerciales de Nissan en Cuba" imagePath="/projectImage.png" dayDate="21" monthDate="03" yearDate="2022" stars="5" reviewsQuant="24"/>
